                        ...
                        <div class="row y-middle">
                            <div class="col-lg-2">
                              <div class="logo-cat-wrap">
                                  <div class="logo-part">
                                      <a href="index.html">
                                          <img src="image/index/dark-logo.png" alt="">
                                      </a>
                                  </div>
                              </div>
                            </div>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                <div class="breadcrumbs-img">
                    <img src="../css/image/login/2.jpg" alt="Breadcrumbs Image">
                </div>
                        ...
                        <div class="main-part">                           
                            <div class="method-account">
                                ...
                                <form action="../PHP_CODE/login.php" method="POST">
                                    <input type="text mb-30" name="username" placeholder="username" required>
                                    <?php
                                        $fullUrl="http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                                        if (strpos($fullUrl,"message=Userdoesntexistinourdatabase")==true) 
                                        {
                                            echo $_GET['message'];
                                    ...
                                    <button type="submit" class="readon submit-btn" name="login">login</button>
