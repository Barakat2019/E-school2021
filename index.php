   	    ...
   	    <div id="loader" class="loader orange-color">
            <div class="loader-container">
                <div class='loader-icon'>
                    <img src="image/index/pre-logo1.png" alt="">
                </div>
            </div>
        </div>
                       ...
                       <div class="row">
                            <div class="col-lg-4 col-md-12 md-mb-30">
                                <div class="features-wrap">
                                    <div class="icon-part">
                                       <img src="image/index/features/icon/3.png" alt="">
                                    </div>
                                    <div class="content-part">
                                        <h4 class="title">
                            ...
                            <div class="col-lg-4 col-md-12 md-mb-30">
                                <div class="features-wrap">
                                    <div class="icon-part">
                                       <img src="image/index/features/icon/2.png" alt="">
                                    </div>
                                    <div class="content-part">
                                      <h4 class="title">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="features-wrap">
                                    <div class="icon-part">
                                       <img src="image/index/features/icon/1.png" alt="">
                                    </div>
                                    <div class="content-part">
                                        <h4 class="title">
                    ...
                    <div class="row mb-35">
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/1.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/1.png" alt="">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/2.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/2.png" alt="">
                                    </div>
                                    <div class="content-wrap">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/3.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/3.png" alt="">
                                    </div>
                                    <div class="content-wrap">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/4.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/4.png" alt="">
                                    </div>
                                    <div class="content-wrap">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/5.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/5.png" alt="">
                                    </div>
                                    <div class="content-wrap">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="categories-items">
                                <div class="cate-image/index">
                                    <a href="#"><img src="image/index/categories/main-home/6.jpg" alt=""></a>
                                </div>
                                <div class="contents">
                                    <div class="img-part">
                                        <img src="image/index/categories/main-home/icon/6.png" alt="">
                                    </div>
                                    <div class="content-wrap">
                         ...
                         <div class="col-lg-4 col-md-6 mb-30">
                                <div class="courses-item">
                                    <div class="courses-grid">
                                         <div class="img-part">
                                             <a href="#"><img src="image/index/courses/main-home/1.jpg" alt=""></a>
                                         </div>
                                         <div class="content-part">
                                             <div class="info-meta">
                                                 <ul>
